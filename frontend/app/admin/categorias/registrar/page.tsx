...
const RegistrarCategoriaPage = () => {
  ...
  useEffect(() => {
    document.title = "Registro de Categoría | Activos Greenfield";
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccess(`Categoría registrada exitosamente: ${nuevaCategoria.nombre}`);
      ...
      setError(error.message || "Error al registrar la categoría");
    } finally {
      hideLoading();
    }
  };
  ...
  return (
    <>
      <Breadcrumb
        pageName="Registro de Categoría"
        description="Añade una nueva categoría al sistema"
      />
              ...
              <div className="shadow-three dark:bg-gray-dark rounded-lg bg-white p-8 sm:p-12">
                ...
                <div className="mt-8 rounded-md bg-blue-50 dark:bg-blue-900/20 p-4">
                  <p className="text-sm text-body-color dark:text-body-color-dark">
                    <strong>Nota:</strong> El nombre de la categoría debe ser único en el sistema.
                  </p>
                </div>
              </div>
            </div>
