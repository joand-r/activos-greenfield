...
const ListaMarcasPage = () => {
  ...
  const guardarCambios = async () => {
    ...
    try {
      ...
      cerrarModal();
      hideLoading();
      toast.success('Cambios guardados', 'La marca ha sido actualizada exitosamente');
    } catch (error: any) {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
            <h2 className="text-3xl font-bold text-black dark:text-white">
              Marcas Registradas ({marcasFiltradas.length})
            </h2>
            <Link
              href="/admin/marcas/registrar"
          ...
          <div className="mb-8">
            <div className="shadow-three dark:bg-gray-dark rounded-lg bg-white dark:border dark:border-gray-700 p-6">
              ...
              <p className="text-3xl font-bold text-primary">{marcas.length}</p>
            </div>
          </div>
      ...
      {/* Modal de Edición */}
      {modalAbierto && marcaSeleccionada && (
