export async function up(client) {
  ...
  await client.query(`
    ...
    CREATE INDEX IF NOT EXISTS idx_activo_nombre ON activo(nombre);
    CREATE INDEX IF NOT EXISTS idx_activo_estado ON activo(estado);
    CREATE INDEX IF NOT EXISTS idx_activo_fecha_adquision ON activo(fecha_adquision);
    ...
    CREATE INDEX IF NOT EXISTS idx_lugar_nombre ON lugar(nombre);
    ...
    CREATE INDEX IF NOT EXISTS idx_activo_lugar_estado ON activo(lugar_id, estado);
  `);
