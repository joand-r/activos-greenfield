...
export const superadminService = {
  ...
  crearUsuario: async (data: any): Promise<UsuarioAdmin> => {
    const response = await api.post('/superadmin/usuarios', data);
    return response.data;
  },

  actualizarUsuario: async (id: number, data: any): Promise<UsuarioAdmin> => {
    const response = await api.put(`/superadmin/usuarios/${id}`, data);
    return response.data;
  },

  eliminarUsuario: async (id: number): Promise<any> => {
    const response = await api.delete(`/superadmin/usuarios/${id}`);
    return response.data;
  },
